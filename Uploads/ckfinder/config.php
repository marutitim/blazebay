...
$config['LicenseName'] = 'LICENSE-NAME';
...
Examples:
	$baseUrl = $_SERVER['HTTP_HOST'] . '/localservicing/ckfinder/files/';
	$baseUrl = '/userfiles/';
...
Examples:
	...
	$baseDir = $_SERVER['DOCUMENT_ROOT'].'/localservicing/ckfinder/files/';
	$baseDir = $_SERVER['DOCUMENT_ROOT'].'/localservicing/ckfinder/userfiles/';
