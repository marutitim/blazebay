        ...
        <div class="panel panel-default">
            ...
            <div class="clearfix cart-total">
                ...
                <div class="pull-right">
                    ...
                    <div class="price"><b>Price: </b> ksh.<?=number_format((float)$productDetails[0]['price']* $currencyRate, 2, '.', '');?></div>
                    ...
                    <span class="text"><b>Sub Total :</b></span><span class='price'><span class="subtotal-sam">
                            ksh.<?=ceil(number_format((float)$productDetails[0]['price']* $currencyRate, 2, '.', '')*$qty);?></span></span><br>
                    <span class="text"><b>Grand Total :</b></span><span class='price'><span class="grandtotal-sam2">
                    ksh.<?=ceil(number_format((float)$productDetails[0]['price']* $currencyRate, 2, '.', '')*$qty);?> </span></span>
