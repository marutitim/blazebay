...
$qry= "select * from bt_location_pricing  where id=$id and uid=" . $this->session->userdata['logged_in']['user_id'];

$res =$this->Site_model-> getcountRecods($qry);

$source=$res[0]['source'];
$destination=$res[0]['destination'];
$sstate=$res[0]['source_state'];
$scity=$res[0]['source_city'];
$dstate=$res[0]['dest_state'];
$dcity=$res[0]['dest_city'];
$currency=$res[0]['currency'];
$price=$res[0]['price'];
$mode=$res[0]['mode'];
$duration=$res[0]['duration'];
$mindistanceKm=$res[0]['min_distance'];
$maxdistanceKm=$res[0]['max_distance'];
$minweight=$res[0]['min_weight'];
$maxweight=$res[0]['max_weight'];
$minvolume=$res[0]['min_volume'];
$maxvolume=$res[0]['max_volume'];
$means=$res[0]['means'];
$otherdetails=$res[0]['otherdetails'];
...
<div class="content">
    ...
    <div class="col-md-12">
        ...
        <div class="featuredpro">
            <div > <h3 class="section-title">Edit  Location Pricing</h3></div>
            ...
            <div id="msgReplies"></div>
                ...
                <form name="locationfrm" method="post" action="#" id="locationfrm" enctype="multipart/form-data">
                    <input type="hidden"    value="<?php  echo $id; ?>" name="locid" >
                    <div class="row edit-margin">
                        ...
                        <div class="col-sm-4" >
                            <fieldset>
                                ...
                                <input type="radio" id="land"  value="land" name="mode" <?php if($mode=='land'){ echo 'checked';} ?>>

                                <label class="control-label" for="recipient-name">By Air <font color="#FF0000">*</font> </label>
                                <input type="radio" id="air"   value="air" name="mode" <?php if($mode=='air'){ echo 'checked';} ?>>

                                <label class="control-label" for="recipient-name">By Sea<font color="#FF0000">*</font> </label>
                                <input type="radio" id="sea"  value="sea" name="mode" <?php if($mode=='sea'){ echo 'checked';} ?>>
                    ...
                    <div class="row edit-margin">
                        ...
                        <div class="col-sm-4" >
                            <select id="means" class="form-control" name="means">
                                <option value="motorbike" <?php if($means=='motorbike'){ echo 'selected';} ?> >Motorbike</option>
                                <option value="pickup" <?php if($means=='pickup'){ echo 'selected';} ?>>Pickup</option>
                                <option value="canter" <?php if($means=='canter'){ echo 'selected';} ?>>Canter</option>
                            </select>
                        </div>
                    </div>
                    <div class="row edit-margin">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <select id="sourceCountry" class="form-control" name="sourceCountry">
                                ...
                                foreach($courireDropdown as $rs) {
                                    ?>
                                    <option  <?php  if($rs["country_id"]==$source){ echo "selected";} ?>  value="<?php echo $rs["country_id"]; ?>"><?php echo $rs["country_name"]; ?></option>
                                <?php
                                }
                                ?>
                    ...
                    <div class="row edit-margin">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            ...
                            <div >
                                <select name="currency" id="currency" class="col-sm-12 form-control" >
                        ...
                        <div class="col-sm-4 col-xs-12">
                            ...
                            <input type="text" class="form-control"   id="mindistanceKm" name="mindistanceKm" value="<?php echo $mindistanceKm; ?>" />
                        </div>
                        <div class="col-sm-4 col-xs-12">
                            <label class="control-label" for="recipient-name">Max. KM : <font color="#FF0000">*</font> </label>
                            <input type="text" class="form-control"   id="maxdistanceKm" name="maxdistanceKm" value="<?php echo $maxdistanceKm; ?>" />
                        </div>
                        <div class="col-sm-4 col-xs-12">
                            <label class="control-label" for="recipient-name">Min. Weight(Kg) : <font color="#FF0000">*</font> </label>
                            <input type="text" class="form-control"  id="minweight"  name="minweight" value="<?php echo $minweight; ?>"/>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                            <label class="control-label" for="recipient-name">Max. Weight(Kg) : <font color="#FF0000">*</font> </label>
                            <input type="text" class="form-control"  id="maxweight"  name="maxweight" value="<?php echo $maxweight; ?>"/>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                            <label class="control-label" for="recipient-name">Min Volume(M<sup>2</sup>): <font color="#FF0000">*</font> </label>
                            <input type="text" class="form-control" id="minvolume" name="minvolume" value="<?php echo $minvolume; ?>"/>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                            <label class="control-label" for="recipient-name">Max Volume(M<sup>2</sup>): <font color="#FF0000">*</font> </label>
                            <input type="text" class="form-control" id="maxvolume" name="maxvolume" value="<?php echo $maxvolume; ?>"/>
                        </div>
                        <div class="col-sm-4 col-xs-12">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            ...
                            <input type="text" class="form-control"   value="<?php echo $duration; ?>" id="duration" name="duration" />
                        </div>
                        <div class="col-sm-4 col-xs-12">
                        ...
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <input name="update_payment" class="btn "  style="background-color:#2873f0;color:#ffffff;" type="button" onclick="return editPricing()" value="Edit Details" class="button">
