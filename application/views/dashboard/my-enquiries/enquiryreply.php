...
<div class="content">
    ...
    <div class="col-md-12">
        ...
        <?php
        $qry="SELECT * FROM bt_enquiry where id=$replyId";
        $replydata = $this->Site_model->execute($qry );
        ?>

        <div class="featuredpro">

        <h3 class="section-title"> <a href="JavaScript:void(0);" >Reply Enquiries Received</a></h3>
            ...
            <form  name="" id="replymsg" class="form-horizontal" method="post" action="" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-8 col-xs-12">
                        ...
                        <div class="ui-widget">
                            ...
                            <input  required="" type="text" name="subject" class="form-control" value="<?php
                            echo $replydata[0]['full_name']; ?>" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-8 col-xs-12">
                        ...
                        <input  required="" type="hidden" name="customerId"  id="customerId" class="form-control" value="<?php
                        echo $replydata[0]['user_id'];?>" >
                        <input  required="" type="text" name="subject"  id="subject" class="form-control" value="<?php
    ...
    function sendreply(){
        ...
        if(contactmessage=== undefined || contactmessage.length == 0){
            ...
            $.ajax({
                ...
                type: "POST",
                data: {replyId:replyId,message: contactmessage, customerId: customerId, subject: subject},
                dataType: "json",
