...
$list=array();
for($i=0;$i<ceil(count($bestsellerProducts)/2);$i++){
    $list[]=array_slice($bestsellerProducts,$i*2,2);
}
                ...
                <div class="product-micro-row">
                    <div>
                        ...
                        <div class="product-info text-left" style="padding-top:2%;">
                            <h3 class="name"><a href="<?=base_url().$productLink ?>"><?=wordtrimer(ucfirst(strtolower($product['title'])),5)?></a></h3>
