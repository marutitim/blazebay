            ...
            <div class="col-md-12 col-sm-12">
                ...
                <table id="cart" class="table table-hover table-condensed" style="height:10% !important;">
                    ...
                    <tr>
                        ...
                        <td data-th="Price"><b></b><?=$productData[0]['min_order']?></td>
            ...
            <div class="col-md-12 col-sm-12">
                <form method="post" action=""  class="Contact_Supplier_Frm" id="Contact_Supplier_Frm" >
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="control-label" for="message-text">Your Message:</label> enter color, size, materials etc. and other specification requirements to receive an accurate quote.
                                <div class="ErrorMessage"></div>
                                <textarea name="contact-message" id="contact-message"><?=$replydata[0]['message']?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div class="form-group" >
                                ...
                                <input name="button"  <?php if(!empty($replydata)){ echo 'disabled';}?> onclick="return submitsupplierContact()" type="button" class="btn btn-primary text-right" value="Submit Enquiry"/>
